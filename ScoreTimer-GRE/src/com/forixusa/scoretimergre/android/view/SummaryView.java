...
import com.forixusa.scoretimergre.android.adapter.SummaryAdapter;
...
public class SummaryView extends ContentView implements OnClickListener {
	...
	public void onResumeUI() {
		...
		if (ScoreTimerApplication.sSummaryTestOption == ScoreTimerApplication.GRE_MATH) {
			mBtnTestOptions.setBackgroundResource(R.drawable.tt_test1);
		} else if (ScoreTimerApplication.sSummaryTestOption == ScoreTimerApplication.GRE_VERBAL) {
