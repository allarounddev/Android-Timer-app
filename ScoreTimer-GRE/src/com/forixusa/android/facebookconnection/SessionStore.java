...
public class SessionStore {
	...
	public static boolean save(Facebook session, Context context) {
		...
		final Editor editor = context.getSharedPreferences(KEY, Context.MODE_PRIVATE).edit();
	...
	public static boolean restore(Facebook session, Context context) {
		...
		final SharedPreferences savedSession = context.getSharedPreferences(KEY, Context.MODE_PRIVATE);
