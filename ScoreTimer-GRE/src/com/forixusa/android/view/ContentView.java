...
import com.forixusa.scoretimergre.android.activities.ShareActivity;
...
import com.forixusa.scoretimergre.android.tabs.ActivityGroupBase;
...
public class ContentView extends FrameLayout {
	...
	public void gotoShare() {
		...
		if (scoreResult.testOption.equals(String.valueOf(ScoreTimerApplication.GRE_MATH))) {
			strTestOption = "GRE Math";
		} else if (scoreResult.testOption.equals(String.valueOf(ScoreTimerApplication.GRE_VERBAL))) {
			strTestOption = "GRE Verbal";
		}

		String shareContent = String.format("I Just got a %s on my latest GRE practice test in %s",
