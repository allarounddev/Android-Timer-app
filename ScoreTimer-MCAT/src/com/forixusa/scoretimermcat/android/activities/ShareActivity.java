...
public class ShareActivity extends Activity implements OnClickListener {
	...
	private final Handler mHandler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			...
			switch (msg.what) {
			case 0:
				AlertHelper.showMessageAlert(ShareActivity.this, "Twiter post failure");
				break;
			case 1:
				AlertHelper.showMessageAlert(ShareActivity.this, "Twiter post successfully");
				break;
			}
		};
	};
	...
	private void initFacebook() {
		...
		SessionStore.FacebookShare.restore(mFacebook, ShareActivity.this);
	...
	private class FacebookAuthListener implements AuthListener {
		...
		public void onAuthSucceed() {
			...
			try {
				...
				SessionStore.FacebookShare.save(mFacebook, ShareActivity.this);
			} catch (final Exception e) {
				e.printStackTrace();
			}
		}
	...
	private void postOnWall(String msg) {
		...
		ShareActivity.this.runOnUiThread(new Runnable() {
			@Override
			public void run() {
				Toast.makeText(ShareActivity.this, "Post to wall successfully.", Toast.LENGTH_SHORT).show();
			}
		});
	}
}
