...
import com.forixusa.scoretimermcat.android.adapter.SummaryAdapter;
...
public class SummaryView extends ContentView implements OnClickListener {
	...
	public void onResumeUI() {
		...
		if (ScoreTimerApplication.sSummaryTestOption == ScoreTimerApplication.BIOLOGICAL_SCIENCES) {
			mBtnTestOptions.setBackgroundResource(R.drawable.tt1);
		} else if (ScoreTimerApplication.sSummaryTestOption == ScoreTimerApplication.PHYSICAL_SCIENCES) {
			mBtnTestOptions.setBackgroundResource(R.drawable.tt2);
		} else if (ScoreTimerApplication.sSummaryTestOption == ScoreTimerApplication.VERBAL_REASONING) {
