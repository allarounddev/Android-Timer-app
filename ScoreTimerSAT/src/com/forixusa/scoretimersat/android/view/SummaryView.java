...
import com.forixusa.scoretimersat.android.adapter.SummaryAdapter;
...
public class SummaryView extends ContentView implements OnClickListener {
	...
	public void onResumeUI() {
		...
		if (ScoreTimerApplication.sSummaryTestOption == ScoreTimerApplication.SAT_MATH) {
			mBtnTestOptions.setBackgroundResource(R.drawable.tt1);
		} else if (ScoreTimerApplication.sSummaryTestOption == ScoreTimerApplication.SAT_READING) {
			mBtnTestOptions.setBackgroundResource(R.drawable.tt2);
		} else if (ScoreTimerApplication.sSummaryTestOption == ScoreTimerApplication.SAT_WRITING) {
