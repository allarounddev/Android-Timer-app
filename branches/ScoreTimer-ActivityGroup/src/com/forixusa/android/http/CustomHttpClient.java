...
public final class CustomHttpClient {
	...
	public static String executeHttpGet(String url,
			...
			ArrayList<NameValuePair> queryParams) throws URISyntaxException,
	...
	public static String executeHttpPost(String url,
			ArrayList<NameValuePair> headers,
			ArrayList<NameValuePair> bodyParams)
		...
		try {
			...
			final byte[] authentication = Base64
					.encodeBytesToBytes(usernamePassword.getBytes());
	...
	public static String executeHttpPost(String url,
			ArrayList<NameValuePair> headers,
			ArrayList<NameValuePair> bodyParams, Bitmap photo)
			throws ClientProtocolException, IOException {
		BufferedReader in = null;
		try {
			final HttpClient client = getHttpClient();
			...
			entity.addPart("photo", new ByteArrayBody(data, "image/jpeg",
					"myPhoto.jpg"));
	...
	private static HttpClient getHttpClient() {
		if (mHttpClient == null) {
			...
			final ClientConnectionManager mgr = mHttpClient
