...
public class SessionEvents {
	public static final String TAG = SessionEvents.class.getSimpleName();
    ...
    public static void onLoginSuccess() {
    	...
    	synchronized (mAuthListeners) {
    		for (AuthListener listener : mAuthListeners) {
    			Log.i(TAG, "listener.onAuthSucceed()");
    ...
    public static void clearListeners() {
    	Log.i(TAG, "clearListeners");
    	
    	if (mAuthListeners != null) {
	    	synchronized (mAuthListeners) {
	    			Log.i(TAG, "clear auth listeners " + mAuthListeners.size());
	    			mAuthListeners.clear();
			}
    	}
    	
    	if (mLogoutListeners != null) {
    		synchronized (mLogoutListeners) {
    			Log.i(TAG, "clear logout listeners " + mLogoutListeners.size());
    	...
    	if (mLogoutListeners != null) {
	    	synchronized (mLogoutListeners) {
	    		for (LogoutListener l : mLogoutListeners) {
	    			...
	    			Log.i(TAG, "clear logout listeners");
	    			mLogoutListeners.clear();
			}
		}
    }
