...
public class DBConstraint {
	...
	public static final String CREATE_TABLE_SCORE_RESULTS = "CREATE VIRTUAL TABLE " + SCORE_RESULT_TABLE_NAME + " USING FTS3("
			+ SCORE_RESULT_ID + " INTEGER PRIMARY KEY, " + DATE + " TEXT, " + ACCURACY + " DOUBLE, " + PACE + " DOUBLE, "
			+ ESTIMATION_SCORE  + "  DOUBLE)";
