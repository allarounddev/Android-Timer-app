...
import com.forixusa.scoretimer.android.tabs.TabAboutUs;
import com.forixusa.scoretimer.android.tabs.TabHome;
import com.forixusa.scoretimer.android.tabs.TabInstruction;
import com.forixusa.scoretimer.android.tabs.TabSummary;
import com.forixusa.scoretimer.android.tabs.TabTimer;
...
public class ScoreTimerActivity extends TabActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mTabHost.addTab(mTabHost.newTabSpec(TAB_TIMER)
				.setIndicator(getLayoutInflater().inflate(R.layout.tab_timer, null))
				.setContent(new Intent(this, TabTimer.class)));
	...
	public void displayTabTimer() {
		mTabHost.setCurrentTabByTag(TAB_TIMER);
	}
