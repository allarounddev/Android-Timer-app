...
public class ContentView extends FrameLayout {
	...
	public void gotoShare() {
		...
		if (scoreResult.testOption.equals(String.valueOf(ScoreTimerApplication.LOGICAL_REASONING))) {
			strTestOption = "Logical Reasoning";
		} else if (scoreResult.testOption.equals(String.valueOf(ScoreTimerApplication.LOGIC_GAME))) {
			strTestOption = "Logic Games";
		} else if (scoreResult.testOption.equals(String.valueOf(ScoreTimerApplication.READING_COMPREHENSION))) {
			strTestOption = "Reading Comprehension";
		}

		String shareContent = String.format("I Just got a %s on my latest LSAT practice test in %s",
