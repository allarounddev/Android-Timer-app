...
public class SummaryView extends ContentView implements OnClickListener {
	...
	public void onResumeUI() {
		...
		if (ScoreTimerApplication.sSummaryTestOption == ScoreTimerApplication.LOGICAL_REASONING) {
			mBtnTestOptions.setBackgroundResource(R.drawable.tt2);
		} else if (ScoreTimerApplication.sSummaryTestOption == ScoreTimerApplication.LOGIC_GAME) {
			mBtnTestOptions.setBackgroundResource(R.drawable.tt3);
		} else if (ScoreTimerApplication.sSummaryTestOption == ScoreTimerApplication.READING_COMPREHENSION) {
