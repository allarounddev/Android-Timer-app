...
import com.forixusa.scoretimeract.android.adapter.SummaryAdapter;
...
public class SummaryView extends ContentView implements OnClickListener {
	...
	public void onResumeUI() {
		...
		if (ScoreTimerApplication.sSummaryTestOption == ScoreTimerApplication.ACT_ENGLISH) {
			mBtnTestOptions.setBackgroundResource(R.drawable.tt1);
		} else if (ScoreTimerApplication.sSummaryTestOption == ScoreTimerApplication.ACT_MATH) {
			mBtnTestOptions.setBackgroundResource(R.drawable.tt2);
		} else if (ScoreTimerApplication.sSummaryTestOption == ScoreTimerApplication.ACT_READING) {
			mBtnTestOptions.setBackgroundResource(R.drawable.tt3);
		} else if (ScoreTimerApplication.sSummaryTestOption == ScoreTimerApplication.ACT_SCIENCE) {
