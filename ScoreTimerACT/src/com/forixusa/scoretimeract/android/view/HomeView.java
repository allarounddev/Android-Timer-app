...
public class HomeView extends ContentView implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.btnEnglish:
			...
			ScoreTimerApplication.sTimerTestOption = ScoreTimerApplication.ACT_ENGLISH;
			final TimerView timerView0 = new TimerView(mContext);
			mActivity.setContentView(timerView0);
			break;
		case R.id.btnMath:
			Log.i(TAG, "btnMath");
			ScoreTimerApplication.sTimerTestOption = ScoreTimerApplication.ACT_MATH;
		...
		case R.id.btnReading:
			...
			ScoreTimerApplication.sTimerTestOption = ScoreTimerApplication.ACT_READING;
		...
		case R.id.btnScience:
			...
			ScoreTimerApplication.sTimerTestOption = ScoreTimerApplication.ACT_SCIENCE;
